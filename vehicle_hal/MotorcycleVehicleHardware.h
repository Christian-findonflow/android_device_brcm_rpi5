...
constexpr int32_t VENDOR_PACK_CYCLES = 0x21400016;         // Total pack cycles (int)
...
constexpr int32_t VENDOR_CELL_LOW_ID = 0x2140001C;         // Low cell ID (int)
constexpr int32_t VENDOR_CELL_HIGH_ID = 0x2140001D;        // High cell ID (int)
constexpr int32_t VENDOR_FAN_SPEED = 0x2140001E;           // Fan speed 0-6 (int)
